...
(function() {
  var FILENAME, PLATFORM, addSource, app, debug, debugOld, doNothing, electron, error, findChromeFlashPath, findSystemFlashPath, flashSources, fs, getAllChromeFlashVersions, getFlashVersion, getNewerVersion, getPath, join, load, log, reVerNum, usingIndex, validatePath;
